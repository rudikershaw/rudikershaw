...
var _typeof = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (e) {
    ...
    return function o(s, u, i) {
        function c(t, e) {
            ...
            var m = e("github-calendar-parser"),
                g = e("elly"),
                h = e("add-subtract-date"),
                y = e("formatoid"),
                M = "MMM D, YYYY",
                v = "MMMM D";function x(e) {
                return e + " " + (1 === e ? "day" : "days");
            }t.exports = function (p, e, b) {
                p = g(p), (b = b || {}).summary_text = b.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>", !1 === b.global_stats && (p.style.minHeight = "175px"), b.proxy = b.proxy || function (e) {
                    return "https://urlreq.appspot.com/req?method=GET&url=" + e;
                };return function f() {
                    return fetch(b.proxy("https://github.com/users/" + e + "/contributions")).then(function (e) {
                        return e.text();
                    }).then(function (e) {
                        var t = document.createElement("div");t.innerHTML = e;var r = t.querySelector(".js-yearly-contributions");if (g(".position-relative h2", r).remove(), r.querySelector(".float-left.text-gray").innerHTML = b.summary_text, r.querySelector("include-fragment")) setTimeout(f, 500);else {
                            if (!0 === b.responsive) {
                                ...
                                var s = m(g("svg", r).outerHTML),
                                    u = s.current_streak ? y(s.current_streak_range[0], v) + " &ndash; " + y(s.current_streak_range[1], v) : s.last_contributed ? "Last contributed in " + y(s.last_contributed, v) + "." : "Rock - Hard Place",
                                    i = s.longest_streak ? y(s.longest_streak_range[0], v) + " &ndash; " + y(s.longest_streak_range[1], v) : s.last_contributed ? "Last contributed in " + y(s.last_contributed, v) + "." : "Rock - Hard Place",
                                    c = g("<div>", { class: "contrib-column contrib-column-first table-column", html: '<span class="text-muted">Contributions in the last year</span>\n                               <span class="contrib-number">' + s.last_year + ' total</span>\n                               <span class="text-muted">' + y(h.add(h.subtract(new Date(), 1, "year"), 1, "day"), M) + " &ndash; " + y(new Date(), M) + "</span>" }),
                                    l = g("<div>", { class: "contrib-column table-column", html: '<span class="text-muted">Longest streak</span>\n                               <span class="contrib-number">' + x(s.longest_streak) + '</span>\n                               <span class="text-muted">' + i + "</span>" }),
                                    d = g("<div>", { class: "contrib-column table-column", html: '<span class="text-muted">Current streak</span>\n                               <span class="contrib-number">' + x(s.current_streak) + '</span>\n                               <span class="text-muted">' + u + "</span>" });r.appendChild(c), r.appendChild(l), r.appendChild(d);
